...
//        urlArgs: "v=1.0",
        ...
        shim: {
            ...
            'bootstrap': {
                deps: ['jquery', 'css!../bower_components/bootstrap/dist/css/bootstrap.min.css', 'css!../bower_components/components-font-awesome/css/font-awesome.min.css']
            },
            "highcharts": {
                deps: ['jquery'],
                exports: "Highcharts"
            ...
            "app": {
                deps: ['domReady', 'angular-jqcloud' , 'angular-resource','angular-animate','angularAMD','ui-bootstrap-tpls','css!../stylesheets/bgmgr/attr.css']
            }
        },
        map: {
            '*': {
    ...
    app.controller('ModalInstanceCtrl',['$uibModalInstance',function ($uibModalInstance) {
        ...
        return function(input,rules) {
            ...
            $.each(rules,function(i,n){
                if(n.expr && n.replace_str){
                    result = result.replace(new RegExp(n.expr,'gm'), n.replace_str)
                }
            });
            return result;
        };
