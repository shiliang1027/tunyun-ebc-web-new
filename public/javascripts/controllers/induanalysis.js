...
define([], function () {
    return ['$scope', 'API', function ($scope, API) {
        $scope.tabs = [
            { index: 0, title: '行业综合分析', templete: 'tpl/induanalysis/tab1.html'},
            { index: 1, title: '行业品类分析', templete: 'tpl/induanalysis/tab2.html'},
            {  index: 2, title: '行业渠道分析', templete: 'tpl/induanalysis/tab3.html'}
        ];
